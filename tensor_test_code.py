...
def main():
  ...
  train_data, train_labels = load_data("D:\\RIT\\631\\Project\\data_project\\resizing_folder\\mixed_train\\") # insert path to training data
  ...
  classifier = tf.estimator.Estimator(
      model_fn=cnn_model_fn, model_dir="D:\\RIT\\631\\Project\\data_project\\Tensorflow_metadata_v5")  # insert path to checkpoint files folder (Tensorflow_metadat_v5) folder
  ...
  eval_input_fn_train = tf.estimator.inputs.numpy_input_fn(
      ...
      num_epochs=1,
      shuffle=True)
  eval_results_test = classifier.evaluate(input_fn=eval_input_fn_test)
  print("\n\nCompleted classifying testing data.....working with training data, please wait!\n\n")
  eval_results_train = classifier.evaluate(input_fn=eval_input_fn_train)
  print("\n\n")
  print("Displaying performance")
  print("----------RESULTS----------------")
  print("--------------------------\n\n")
  print("Models Testing accuracy:\t"+str(round(eval_results_test['accuracy']*100,2))+"%")
  print("-----")
  print("Confusion Matrix:\n")
  print(eval_results_test['conv_matrix'])
  print("-----")
  print("Models Training accuracy:\t" + str(round(eval_results_train['accuracy'] * 100, 2)) + "%")
  print("-----")
  print("Confusion Matrix:\n")
  print(eval_results_train['conv_matrix'])
  print("--------------------------")
  print("-------------END-------------")
main()